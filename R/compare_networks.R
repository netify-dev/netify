...
compare_networks <- function(
    ...
    # 
    if (what == "edges") {
        results <- compare_edges(nets_list, method, test, n_permutations, 
                               include_diagonal, edge_threshold, return_details)
    } else if (what == "structure") {
        results <- compare_structure(nets_list, test)
    } else if (what == "nodes") {
        results <- compare_nodes(nets_list, return_details)
    } else if (what == "attributes") {
        results <- compare_attributes(nets_list, test, n_permutations, return_details)
    }
