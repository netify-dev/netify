...
#' then it simply calls `new_netify`. Otherwise, it calls `decompose_igraph` 
#' or `decompose_statnet` to extract adjacency matrix 
...
#' @aliases to_netify, as_netify, as.netify
...
#' @rdname prep_for_netify
#' @export
to_netify <- prep_for_netify

#' @rdname prep_for_netify
#' @export
as_netify <- prep_for_netify

#' @rdname prep_for_netify
#' @export
as.netify <- prep_for_netify
