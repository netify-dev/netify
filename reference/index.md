...
- [`add_node_vars()`](https://netify-dev.github.io/netify/reference/add_node_vars.md)
  [`add_vertex_attributes()`](https://netify-dev.github.io/netify/reference/add_node_vars.md)
  : Add nodal variables to a netify object
- [`add_dyad_vars()`](https://netify-dev.github.io/netify/reference/add_dyad_vars.md)
  [`add_edge_attributes()`](https://netify-dev.github.io/netify/reference/add_dyad_vars.md)
...
- [`print(`*`<netify_comparison>`*`)`](https://netify-dev.github.io/netify/reference/print.netify_comparison.md)
...
- [`get_edge_layout()`](https://netify-dev.github.io/netify/reference/get_edge_layout.md)
...
- [`create_hierarchical_ego_layout()`](https://netify-dev.github.io/netify/reference/ego_layouts.md)
  [`create_radial_ego_layout()`](https://netify-dev.github.io/netify/reference/ego_layouts.md)
...
- [`icews`](https://netify-dev.github.io/netify/reference/icews.md) :
