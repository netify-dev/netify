...
pakistan_comparison <- compare_networks(pakistan_ego_net)
...
compare_networks(ego_net)                       # Temporal comparison
compare_networks(list(ego1, ego2))              # Cross-sectional comparison
```
