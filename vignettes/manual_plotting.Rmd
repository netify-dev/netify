...
description: "Customize netify plot data directly with ggplot2 layers and scales."
...
The advanced sections also use `dplyr` (for data manipulation) and `ggnewscale` (for multiple color legends).
