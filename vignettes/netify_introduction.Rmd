...
- See (https://svmiller.com/peacesciencer/ms.html) for more information. Users will need to install this package to run the examples below.
...
To begin, let's create a dyadic dataset to work with using *peacesciencer*. 
