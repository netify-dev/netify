---
title: "Tracking Changes & Comparing Networks"
...
# This vignette requires dplyr, tidyr, and patchwork.
# Exit gracefully with an actionable message if any are missing.
pkg_check <- c("dplyr", "tidyr", "patchwork")
...
- **Range**: correlations span 0.42 to 0.64, all positive -- interaction density drives a baseline overlap even between cooperation and conflict.
...
5. Use `permutation_type = "freedman_lane"` or `"dsp_mrqap"` when comparing networks that may have autocorrelation
6. Set `correlation_type = "spearman"` for networks with skewed weight distributions
...
7. **Statistical Validation**: `compare_networks(nets, method="qap", permutation_type="...")`
...
2. Freedman, D., & Lane, D. (1983). A nonstochastic interpretation of reported significance levels. Journal of Business & Economic Statistics, 1(4), 292–298.

3. Dekker, D., Krackhardt, D., & Snijders, T. A. B. (2007). Sensitivity of MRQAP tests to collinearity and autocorrelation conditions. Psychometrika, 72(4), 563–581. 
