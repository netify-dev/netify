...
```{r, fig.width=6, fig.height=6}
select_names <- c("EZLN", "Jalisco Cartel New Generation", "Los Caballeros Templarios", "Autodefensas Unidas de Michoacán", "Gulf Cartel", "Los Zetas", "Beltrán Leyva Cartel", "Government of Mexico")
