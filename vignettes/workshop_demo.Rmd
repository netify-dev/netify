...
#summary_df_static = summary_df_static %>% group_by(time)
names(summary_df_static)[names(summary_df_static) == "time"] <- "temp"
...
Instead of looking at summary statistics, it is useful to visualize the entire network. We can do this by plotting the netify object. (Isolates removed by default and seed set to 6886 for node layout).
=======
...
>>>>>>> 21ed6559aa44207d73e0100aebeb3b51cfe6f875
