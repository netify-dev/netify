...
Additionally, since the result of `plot_actor_stats` is a `ggplot2` object, users can also choose to facet the plot by actors and variables, as shown below:
...
plot_actor_stats(
  ...
  facet_grid(variable~actor, scales='free')
```
