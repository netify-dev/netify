...
# dyadic weights
dim(mids_longit_prep$Y)

# array of dyadic attributes
dim(mids_longit_prep$Xdyad)

# array of nodal attributes for rows
dim(mids_longit_prep$Xrow)

# array of nodal attributes for columns
dim(mids_longit_prep$Xcol)

# core amen modeling function (how best longit?)
# get apply error
# ame_repL(Y = mids_longit_prep$Y, 
#         Xdyad = mids_longit_prep$Xdyad,
#         Xrow = mids_long_prep$Xrow,
#         model="bin")
```
